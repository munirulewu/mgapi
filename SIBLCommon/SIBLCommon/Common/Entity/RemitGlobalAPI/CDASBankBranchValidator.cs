...
{
    public class CDASBankBranchValidator : AbstractValidator<CDAS>
    {
        CAppSettingConstant oAppSettingConstant = new CAppSettingConstant();
        public CDASBankBranchValidator()
        {
            //systeminfo
           ...
           //other
            ...
            RuleFor(x => x.BankId).NotEmpty().WithMessage(oAppSettingConstant.messageforCode1001).WithErrorCode(oAppSettingConstant.responseCode1001);
            RuleFor(x => x.BankId).Length(1,6).WithMessage(oAppSettingConstant.messageforCode1002).WithErrorCode(oAppSettingConstant.responseCode1002);
        }
    }
}
